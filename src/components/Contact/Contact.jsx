  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const result = await emailjs.send(
        ...
        'template_ufg5h1p',
        {
          subject: formData.subject, // This will be the email subject
          name: formData.name,
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-start">
          ...
          >
            ...
            {/* Contact Details - Simplified without map */}
            <motion.div variants={itemVariants} className="space-y-4">
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-300 text-sm">6369623214</p>
                </div>
                <div className="text-purple-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300">→</div>
              </motion.a>
          ...
          {/* Contact Form with Shimmer Border Card */}
          <motion.div
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-900/90 backdrop-blur-xl rounded-2xl border border-white/10 p-6 lg:p-8">
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                  ...
                  {/* Updated Send Message Button with Enhanced Hover Effects */}
                  <motion.button
                    type="submit"
                    disabled={isLoading}
                    whileHover={{ 
